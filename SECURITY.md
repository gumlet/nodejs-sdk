...
This is a generated TypeScript SDK for Gumlet, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Gumlet API or service rather than in this SDK, report it through the security process Gumlet has published.
